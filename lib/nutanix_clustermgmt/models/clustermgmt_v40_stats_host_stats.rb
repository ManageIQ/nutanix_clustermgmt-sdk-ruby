...
module NutanixClustermgmt
  ...
  class ClustermgmtV40StatsHostStats
    ...
    attr_accessor :overall_memory_usage_ppm

    # Upper Buf value of overall memory usage(ppm).
    attr_accessor :overall_memory_usage_ppm_upper_buf

    # Lower Buf value of overall memory usage(ppm).
    attr_accessor :overall_memory_usage_ppm_lower_buf
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixClustermgmt::ClustermgmtV40StatsHostStats`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
