...
module NutanixClustermgmt
  class ClustermgmtV40ConfigTaskResponse
    ...
    attr_accessor :task_response_type
    ...
    def self.openapi_types
      {
        ...
        :'task_response_type' => :'ClustermgmtV40ConfigTaskResponseType',
        :'response' => :'ClustermgmtV40ConfigTaskResponseAllOfResponse'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixClustermgmt::ClustermgmtV40ConfigTaskResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixClustermgmt::ClustermgmtV40ConfigTaskResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'task_response_type')
        self.task_response_type = attributes[:'task_response_type']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ext_id == o.ext_id &&
          links == o.links &&
          task_response_type == o.task_response_type &&
          response == o.response
    end
    ...
    def hash
      [tenant_id, ext_id, links, task_response_type, response].hash
    end
