...
module NutanixClustermgmt
  # Host GPU details.
  class ClustermgmtV40ConfigHostGpu < ApiModelBase
    ...
    attr_accessor :number_of_vgpus_allocated
    ...
    def self.openapi_types
      {
        ...
        :'number_of_vgpus_allocated' => :'Integer',
        :'config' => :'ClustermgmtV40ConfigVirtualGpuConfig'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixClustermgmt::ClustermgmtV40ConfigHostGpu` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixClustermgmt::ClustermgmtV40ConfigHostGpu`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'number_of_vgpus_allocated')
        self.number_of_vgpus_allocated = attributes[:'number_of_vgpus_allocated']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          node_id == o.node_id &&
          cluster == o.cluster &&
          number_of_vgpus_allocated == o.number_of_vgpus_allocated &&
          config == o.config
    end
    ...
    def hash
      [tenant_id, ext_id, links, node_uuid, node_id, cluster, number_of_vgpus_allocated, config].hash
    end
