  ...
  class ClustermgmtV40ConfigComputeNodeItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixClustermgmt::ClustermgmtV40ConfigComputeNodeItem` initialize method"
      end
    ...
    def hash
      [node_uuid, block_id, node_position, hypervisor_ip, ipmi_ip, digital_certificate_map_list, hypervisor_hostname, model].hash
    end
