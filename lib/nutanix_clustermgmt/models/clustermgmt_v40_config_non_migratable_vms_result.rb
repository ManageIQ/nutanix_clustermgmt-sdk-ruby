...
module NutanixClustermgmt
  class ClustermgmtV40ConfigNonMigratableVmsResult < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'vms' => :'Array<ClustermgmtV40ConfigNonMigratableVmInfo>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixClustermgmt::ClustermgmtV40ConfigNonMigratableVmsResult` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixClustermgmt::ClustermgmtV40ConfigNonMigratableVmsResult`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@vms.nil? && @vms.length > 1024
        invalid_properties.push('invalid value for "vms", number of items must be less than or equal to 1024.')
      end
    ...
    def valid?
      ...
      return false if !@vms.nil? && @vms.length > 1024
    ...
    def vms=(vms)
      ...
      if vms.length > 1024
        fail ArgumentError, 'invalid value for "vms", number of items must be less than or equal to 1024.'
      end
    ...
    def hash
      [tenant_id, ext_id, links, vms].hash
    end
