...
module NutanixClustermgmt
  ...
  class ClustermgmtV40ConfigBundleParam < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'node_list' => :'Array<ClustermgmtV40ConfigNodeInfo>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixClustermgmt::ClustermgmtV40ConfigBundleParam` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixClustermgmt::ClustermgmtV40ConfigBundleParam`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @bundle_info.nil?
        invalid_properties.push('invalid value for "bundle_info", bundle_info cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @bundle_info.nil?
    ...
    # @param [Object] bundle_info Value to be assigned
    def bundle_info=(bundle_info)
      if bundle_info.nil?
        fail ArgumentError, 'bundle_info cannot be nil'
      end
