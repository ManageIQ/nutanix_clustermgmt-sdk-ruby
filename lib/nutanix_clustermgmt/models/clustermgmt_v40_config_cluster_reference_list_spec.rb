...
module NutanixClustermgmt
  class ClustermgmtV40ConfigClusterReferenceListSpec
    ...
    def self.openapi_types
      {
        :'clusters' => :'Array<ClustermgmtV40ConfigClusterReference>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixClustermgmt::ClustermgmtV40ConfigClusterReferenceListSpec` initialize method"
      end
    ...
    def valid?
      ...
      return false if @clusters.length > 400
      return false if @clusters.length < 1
      true
    end
