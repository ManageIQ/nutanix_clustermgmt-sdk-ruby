...
module NutanixClustermgmt
  class ClustermgmtV40ConfigEncryptionScopeInfo
    ...
    def build_from_hash(value)
      return value if ClustermgmtV40ConfigEncryptionScopeInfo.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ClustermgmtV40ConfigEncryptionScopeInfo"
    end
  end
end
