...
module NutanixClustermgmt
  class ClustermgmtV40ConfigRsyslogModuleLogSeverityLevel
    ...
    def build_from_hash(value)
      return value if ClustermgmtV40ConfigRsyslogModuleLogSeverityLevel.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ClustermgmtV40ConfigRsyslogModuleLogSeverityLevel"
    end
  end
end
