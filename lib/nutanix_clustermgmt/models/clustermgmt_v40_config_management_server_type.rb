...
module NutanixClustermgmt
  class ClustermgmtV40ConfigManagementServerType
    ...
    def build_from_hash(value)
      return value if ClustermgmtV40ConfigManagementServerType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ClustermgmtV40ConfigManagementServerType"
    end
  end
end
