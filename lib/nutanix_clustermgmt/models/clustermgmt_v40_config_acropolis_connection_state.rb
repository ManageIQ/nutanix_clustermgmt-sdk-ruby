...
module NutanixClustermgmt
  class ClustermgmtV40ConfigAcropolisConnectionState
    ...
    def build_from_hash(value)
      return value if ClustermgmtV40ConfigAcropolisConnectionState.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ClustermgmtV40ConfigAcropolisConnectionState"
    end
  end
end
