...
module NutanixClustermgmt
  ...
  class ApplyClusterProfile202Response < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixClustermgmt::ApplyClusterProfile202Response` initialize method"
      end
