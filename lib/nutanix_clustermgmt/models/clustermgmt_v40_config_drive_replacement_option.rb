...
module NutanixClustermgmt
  class ClustermgmtV40ConfigDriveReplacementOption
    ...
    def build_from_hash(value)
      return value if ClustermgmtV40ConfigDriveReplacementOption.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ClustermgmtV40ConfigDriveReplacementOption"
    end
  end
end
