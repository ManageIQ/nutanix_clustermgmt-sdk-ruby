...
module NutanixClustermgmt
  class ClustermgmtV40ConfigPIIScrubbingLevel
    ...
    def build_from_hash(value)
      return value if ClustermgmtV40ConfigPIIScrubbingLevel.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ClustermgmtV40ConfigPIIScrubbingLevel"
    end
  end
end
