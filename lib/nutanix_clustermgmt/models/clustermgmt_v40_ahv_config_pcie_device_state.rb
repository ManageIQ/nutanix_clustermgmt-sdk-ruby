...
module NutanixClustermgmt
  class ClustermgmtV40AhvConfigPcieDeviceState
    UVM_AVAILABLE = "UVM_AVAILABLE".freeze
    UVM_RESERVED = "UVM_RESERVED".freeze
    ...
    def build_from_hash(value)
      return value if ClustermgmtV40AhvConfigPcieDeviceState.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ClustermgmtV40AhvConfigPcieDeviceState"
    end
  end
end
